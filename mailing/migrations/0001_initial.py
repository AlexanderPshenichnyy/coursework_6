    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(blank=True, choices=[('Успешно', 'Success'), ('Неуспешно', 'Failed')], max_length=9,
                                  null=True, verbose_name='статус отправки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                            ...
                                            to=settings.AUTH_USER_MODEL, verbose_name='автор рассылки')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailing_period', models.CharField(blank=True,
                                                    choices=[('daily', 'Ежедневно'), ('weekly', 'Еженедельно'),
                                                             ('monthly', 'Ежемесячно')], max_length=12, null=True,
                                                    verbose_name='периодичность')),
                ('mailing_status',
                 models.CharField(choices=[('created', 'Создана'), ('running', 'Запущена'), ('completed', 'Завершена')],
                                  default='created', max_length=10, verbose_name='статус рассылки')),
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='settings',
                                              related_query_name='setting', to='mailing.mailingmessage',
                                              verbose_name='рассылка')),
                ('recipient',
                 models.ManyToManyField(related_name='clients', to='clients.client', verbose_name='клиенты')),
            ],
            options={
